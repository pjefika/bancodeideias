...
public class EfikaUsers_ServiceLocator extends org.apache.axis.client.Service implements bancodeideias.dal.webservice.EfikaUsers_Service {
    ...
    private java.lang.String _8_address = "http://10.200.35.67:80/EfikaWs/EfikaUsers";
    ...
    public bancodeideias.dal.webservice.EfikaUsers_PortType get_8() throws javax.xml.rpc.ServiceException {
    ...
    public bancodeideias.dal.webservice.EfikaUsers_PortType get_8(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            bancodeideias.dal.webservice.EfikaUsersSoapBindingStub _stub = new bancodeideias.dal.webservice.EfikaUsersSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(@SuppressWarnings("rawtypes") Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (bancodeideias.dal.webservice.EfikaUsers_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                bancodeideias.dal.webservice.EfikaUsersSoapBindingStub _stub = new bancodeideias.dal.webservice.EfikaUsersSoapBindingStub(new java.net.URL(_8_address), this);
                _stub.setPortName(get_8WSDDServiceName());
                return _stub;
            }
        }
