...
public class EfikaUsersProxy implements bancodeideias.dal.webservice.EfikaUsers_PortType {
  private String _endpoint = null;
  private bancodeideias.dal.webservice.EfikaUsers_PortType efikaUsers_PortType = null;
  ...
  private void _initEfikaUsersProxy() {
    try {
      efikaUsers_PortType = (new bancodeideias.dal.webservice.EfikaUsers_ServiceLocator()).get_8();
  ...
  public bancodeideias.dal.webservice.EfikaUsers_PortType getEfikaUsers_PortType() {
    if (efikaUsers_PortType == null)
      _initEfikaUsersProxy();
